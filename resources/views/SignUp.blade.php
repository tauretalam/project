...
<section class="bg-success bg-opacity-75 py-5 my-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <h2 class="fw-bold">
                    Connect With GreenSathi
                </h2>

                <form>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Phone Number</label>
    <input type="bigint" class="form-control" id="exampleInputEmail1" placeholder="9876543210" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text">We'll never share your Phone Number with anyone else.</div>
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="greensathi12@gmail.com" aria-describedby="emailHelp">
  ...
  <button type="submit" class="btn btn-warning ">Singup</button>
