...
<div class="card text-bg-dark border-0 mt-5">
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-center">
        <p class="card-text  fs-6">CONTACT US</p>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <h6><i class="fa-solid fa-phone" style="color: rgb(14, 201, 40);"></i> Phone</h6>
                <p class="fs-6">
                    9876543210
                </p>

                <h6><i class="fa-solid fa-envelope" style="color: rgb(14, 201, 40);"></i> Email</h6>
                <p class="fs-6">
                    example.user@email.com
                </p>

                <h6><i class="fa-solid fa-location-dot" style="color: rgb(14, 201, 40);"></i> Addresh</h6>
                <p class="fs-6">
                    1234 Sample Street, Test City, TC 56789, Country
                </p>
            </div>
...
<section class="bg-success bg-opacity-75 py-5">
    <div class="container">
        <div class="row align-items-center">
            <h2 class="fw-bold text-center">Follow us @GreenSathi Co.</h2>

           <div class="text-center mt-3">
            <i class="fa-brands fa-facebook fa-xl mx-2" style="color: rgb(0, 7, 1);"></i>
            <i class="fa-brands fa-youtube fa-xl mx-2" style="color: rgb(0, 7, 1);"></i>
            <i class="fa-brands fa-instagram fa-xl mx-2" style="color: rgb(0, 7, 1);"></i>
            <i class="fa-brands fa-pinterest fa-xl mx-2" style="color: rgb(0, 7, 1);"></i>
            <i class="fa-brands fa-x-twitter fa-xl mx-2" style="color: rgb(0, 7, 1);"></i>
           </div>
